...
public:
	MovableTextOverlayAttributes(const Ogre::UTFString & name, const Ogre::Camera *cam,
						 const Ogre::UTFString & fontName = "orbitron-medium", const int &charHeight = 16, const Ogre::ColourValue & color = Ogre::ColourValue::White, const Ogre::UTFString & materialName = "");
...
*/
	mTimeTilUpdate = mUpdateFrequency;
...
{
	mTimeTilUpdate -= timeSincelastFrame;
