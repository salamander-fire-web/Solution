...
public:
	...
	void pushChar(const unsigned int &a)
	{
		...
		tempStoragePos = -1;
		UTFString temp = "";
		if(a > 191 && a < 257) temp.push_back(a + 848);
		else if(a==184) temp.push_back(a + 921);
		else if(a==168) temp.push_back(a + 857);
	...
	void setInputBox(OverlayElement *inputBox, const String &caption, unsigned short limit, bool clear, const UTFString &startText, bool bTempStorage, bool bNewLine, bool bHideText)
	{
