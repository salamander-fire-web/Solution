...
#define MAX_BOXES 24
#define MAX_BUTTONS 90
#define MAX_SIZERS 1
#define MAX_MOVERS 8
#define MAX_SCROLLERS 18
...
#include "MagixLanguageManager.h"
...
public:
	...
	void initialize(SceneManager *sceneMgr, RenderWindow *window, MagixExternalDefinitions *def, MagixGameStateManager *gameStateMgr, MagixItemManager *itemManager, MagixCritterManager *critterMgr, MagixUnitManager *unitManager, MagixNetworkManager *networkManager, MagixCamera *camera, MagixSoundManager *soundMgr, MagixEffectsManager *effectsMgr, MagixCollisionManager *collisionMgr, MagixLanguageManager *lang)
	{
		...
		mButtonText[BUTTON_GAMEOVERQUIT]->setCaption(mLang->Quit());
		...
		mButtonText[BUTTON_OPTIONRESUME]->setCaption(mLang->Resume());
		...
		mButtonText[BUTTON_OPTIONSETTINGS]->setCaption(mLang->Settings());
		...
		mButtonText[BUTTON_OPTIONINTERFACE]->setCaption(mLang->Interface());
		...
		mButtonText[BUTTON_OPTIONRESTART]->setCaption(mLang->Restart());
		...
		mButtonText[BUTTON_OPTIONQUIT]->setCaption(mLang->Quit());
		...
		mButtonText[BUTTON_SETTINGSBACK]->setCaption(mLang->Back());
		for(int i=0;i<4;i++)
		{
			const String tNum = StringConverter::toString(i+1);
		...
		mButtonText[BUTTON_INTERFACEBACK]->setCaption(mLang->Back());
		...
		mButton[BUTTON_ABOUT] = OverlayManager::getSingleton().getOverlayElement("GUI/StartScreenButton4");
		mButtonText[BUTTON_ABOUT] = OverlayManager::getSingleton().getOverlayElement("GUI/StartScreenButtonText4");
		...
		OverlayManager::getSingleton().getOverlayElement("GUI/UpdateBoxText")->setCaption(mLang->Update());
		...
		mButtonText[BUTTON_LOGON1]->setCaption(mLang->Login());
		...
		mButtonText[BUTTON_NEWACCOUNT]->setCaption(mLang->NewAccount());
		...
		mButton[BUTTON_INTERFACE9] = OverlayManager::getSingleton().getOverlayElement("GUI/InterfaceButton9");
		mButtonText[BUTTON_INTERFACE9] = OverlayManager::getSingleton().getOverlayElement("GUI/InterfaceButtonText9");
		mButtonText[BUTTON_EDITACCOUNT]->setCaption(mLang->ChangePass());
		...
		mButtonText[BUTTON_LOGONBACK]->setCaption(mLang->Back());
		mCheckBox[CHECKBOX_LOGON] = OverlayManager::getSingleton().getOverlayElement("GUI/LogonCheckBox");
		OverlayManager::getSingleton().getOverlayElement("GUI/LogonText1")->setCaption(mLang->Multiplayer());

		showLogonOverlay(false);

		//AboutGUI
		mBox[GUI_CREDITBOX] = OverlayManager::getSingleton().getOverlayElement("GUI/CreditBox");
		mButton[BUTTON_FORUM] = OverlayManager::getSingleton().getOverlayElement("GUI/VisitForum");
		mButtonText[BUTTON_FORUM] = OverlayManager::getSingleton().getOverlayElement("GUI/VisitForumText");
		mButtonText[BUTTON_FORUM]->setCaption(mLang->Forum());
		mButton[BUTTON_VK] = OverlayManager::getSingleton().getOverlayElement("GUI/VisitVK");
		mButtonText[BUTTON_VK] = OverlayManager::getSingleton().getOverlayElement("GUI/VisitVKText");
		mButtonText[BUTTON_VK]->setCaption(mLang->VK());
		mButton[BUTTON_CREDITBACK] = OverlayManager::getSingleton().getOverlayElement("GUI/CreditBack");
		mButtonText[BUTTON_CREDITBACK] = OverlayManager::getSingleton().getOverlayElement("GUI/CreditBackText");
		mButtonText[BUTTON_CREDITBACK]->setCaption(mLang->Back());
		OverlayManager::getSingleton().getOverlayElement("GUI/CreditTitle")->setCaption(mLang->About());
		OverlayManager::getSingleton().getOverlayElement("GUI/CreditText")->setCaption(mLang->Credit());

		showCreditOverlay(false);
		...
		mButtonText[BUTTON_CREATEACCOUNT1]->setCaption(mLang->NewAccount());
		...
		mButtonText[BUTTON_CREATEACCOUNTBACK]->setCaption(mLang->Back());

		for(int i=0;i<MAX_CREATEACCOUNTINFO;i++)
			mCreateAccountTextBox[i] = OverlayManager::getSingleton().getOverlayElement("GUI/CreateAccountText"+StringConverter::toString(i+1));
		OverlayManager::getSingleton().getOverlayElement("GUI/SettingsText1")->setCaption(mLang->Music());
		OverlayManager::getSingleton().getOverlayElement("GUI/SettingsText2")->setCaption(mLang->GUISound());
		OverlayManager::getSingleton().getOverlayElement("GUI/SettingsText3")->setCaption(mLang->Sound());
		OverlayManager::getSingleton().getOverlayElement("GUI/SettingsText4")->setCaption(mLang->Shadows());
		OverlayManager::getSingleton().getOverlayElement("GUI/SettingsText5")->setCaption(mLang->Bloom());
		OverlayManager::getSingleton().getOverlayElement("GUI/SettingsText6")->setCaption(mLang->Geometry());
		OverlayManager::getSingleton().getOverlayElement("GUI/SettingsText7")->setCaption(mLang->Distance());
		OverlayManager::getSingleton().getOverlayElement("GUI/InterfaceText1")->setCaption(mLang->Tablet());
		OverlayManager::getSingleton().getOverlayElement("GUI/InterfaceText2")->setCaption(mLang->Sensitivity());
		OverlayManager::getSingleton().getOverlayElement("GUI/InterfaceText3")->setCaption(mLang->GeneralName());
		OverlayManager::getSingleton().getOverlayElement("GUI/InterfaceText4")->setCaption(mLang->LocalName());
		OverlayManager::getSingleton().getOverlayElement("GUI/InterfaceText5")->setCaption(mLang->ChButtonBlink());
		OverlayManager::getSingleton().getOverlayElement("GUI/InterfaceText6")->setCaption(mLang->RunMode());
		OverlayManager::getSingleton().getOverlayElement("GUI/InterfaceText7")->setCaption(mLang->DoubleJump());
		OverlayManager::getSingleton().getOverlayElement("GUI/InterfaceText8")->setCaption(mLang->LipSync());
		OverlayManager::getSingleton().getOverlayElement("GUI/InterfaceText9")->setCaption(mLang->WindowCursor());
		OverlayManager::getSingleton().getOverlayElement("GUI/InterfaceText10")->setCaption(mLang->Language());
		...
		mButtonText[BUTTON_EDITACCOUNT1]->setCaption(mLang->Confirm());
		...
		mButtonText[BUTTON_EDITACCOUNTBACK]->setCaption(mLang->Back());
		OverlayManager::getSingleton().getOverlayElement("GUI/EditAccountText")->setCaption(mLang->ChangePass());
		//OverlayManager::getSingleton().getOverlayElement("GUI/EditAccountText1")->setCaption(mLang->Username());
		//OverlayManager::getSingleton().getOverlayElement("GUI/EditAccountText2")->setCaption(mLang->OldPass());
		//OverlayManager::getSingleton().getOverlayElement("GUI/EditAccountText3")->setCaption(mLang->NewPass());
		//OverlayManager::getSingleton().getOverlayElement("GUI/EditAccountText4")->setCaption(mLang->ConfirmPass());
		...
		mButtonText[BUTTON_CAMPAIGNBACK]->setCaption(mLang->Back());
		...
		mButtonText[BUTTON_CAMPAIGNNEXT]->setCaption(mLang->Next());
		for(int i=0;i<3;i++)
		{
			const String tNum = StringConverter::toString(i+1);
		...
		mButtonText[BUTTON_CHARSCREENBACK]->setCaption(mLang->Back());
		...
		mButtonText[BUTTON_CHARSCREENNEXT]->setCaption(mLang->Back());
		...
		mCharScreenManager->initialize(mDef,mEffectsManager,mAlertBox,mUnitManager->getPlayer(),sceneMgr,mBoxText[GUI_CHARSCREENBOX],mBackdrop,mLang);
		...
		OverlayManager::getSingleton().getOverlayElement("GUI/SettingsButtonText1")->setCaption(mLang->Off());
		OverlayManager::getSingleton().getOverlayElement("GUI/SettingsButtonText2")->setCaption(mLang->Off());
		OverlayManager::getSingleton().getOverlayElement("GUI/SettingsButtonText3")->setCaption(mLang->Off());
		OverlayManager::getSingleton().getOverlayElement("GUI/InterfaceButtonText1")->setCaption(mLang->Off());
		OverlayManager::getSingleton().getOverlayElement("GUI/InterfaceButtonText7")->setCaption(mLang->Off());
		OverlayManager::getSingleton().getOverlayElement("GUI/InterfaceButtonText8")->setCaption(mLang->Off());
		OverlayManager::getSingleton().getOverlayElement("GUI/InterfaceButtonText4")->setCaption(mLang->On());
		OverlayManager::getSingleton().getOverlayElement("GUI/InterfaceButtonText6")->setCaption(mLang->On());
		OverlayManager::getSingleton().getOverlayElement("GUI/InterfaceButtonText5")->setCaption(mLang->Absolute());
		OverlayManager::getSingleton().getOverlayElement("GUI/InterfaceButtonText2")->setCaption(mLang->Username2());
		OverlayManager::getSingleton().getOverlayElement("GUI/InterfaceButtonText3")->setCaption(mLang->Character());
	...
	void showBackdropOverlay(bool flag, bool showLoadingText=false, const String &loadingCaption="Loading...")
	{
		...
		if(flag)
		{
			...
			if (mGameStateManager->isInGame() && !mGameStateManager->isCampaign())
			{
			 int random = Math::RangeRandom(1,5);
				switch(random)
				{
				case 1:
					mBackdrop->setMaterialName("GUIMat/LoadScreen1");
					break;
				case 2:
					mBackdrop->setMaterialName("GUIMat/LoadScreen2");
					break;
				case 3:
					mBackdrop->setMaterialName("GUIMat/LoadScreen3");
					break;
				case 4:
					mBackdrop->setMaterialName("GUIMat/LoadScreen4");
					break;
				}
			}
		}
	...
	void showCreditOverlay(bool flag)
	{
		if(flag)
		{
			OverlayManager::getSingleton().getByName("GUIOverlay/CreditScreen")->show();
			mBox[GUI_CREDITBOX]->show();
		}
		else
		{
			OverlayManager::getSingleton().getByName("GUIOverlay/CreditScreen")->hide();
			mBox[GUI_CREDITBOX]->hide();
		}
	}
	...
	void updatePlayer(const FrameEvent &evt)
	{
		...
		if(mUnitManager->getPlayer()->popWoundedChanged())
		{
			if(mUnitManager->getPlayer()->getIsWounded())
			{
				...
				mChatManager->message(mLang->YouWonded());
			...
			else
			{
				...
				setWounded(false);
				mChatManager->message(mLang->YouRecovered());
	...
	void updateNetworkMessage()
	{
		...
		case NETWORK_LOGONSUCCESS:
			...
			OverlayManager::getSingleton().getOverlayElement("GUI/LogonPasswordText")->setCaption(mLang->Password());
		...
		case NETWORK_LOGONFAIL:
			...
			showOptionsOverlay(false);
			showBackdropOverlay(true,false);
			mAlertBox->showAlert(mLang->InvUoP(),0.5,0.5,3);
		...
		case NETWORK_LOGONINUSE:
			...
			showOptionsOverlay(false);
			showBackdropOverlay(true,false);
			mAlertBox->showAlert(mLang->UserAlready(),0.5,0.5,3);
			mNetworkManager->disconnect();
			break;
		case NETWORK_CREATEACCOUNTSUCCESS:
			...
			showOptionsOverlay(false);
			showBackdropOverlay(true,false);
			mAlertBox->showAlert(mLang->AccCreated(),0.5,0.5,2);
			mNetworkManager->disconnect();
			break;
		case NETWORK_CREATEACCOUNTFAIL:
			...
			showOptionsOverlay(false);
			showBackdropOverlay(true,false);
			mAlertBox->showAlert(mLang->UserUse(),0.5,0.5,3);
			mNetworkManager->disconnect();
			break;
		case NETWORK_EDITACCOUNTSUCCESS:
			...
			showOptionsOverlay(false);
			showBackdropOverlay(true,false);
			mAlertBox->showAlert(mLang->PassChanged(),0.5,0.5,2);
			mNetworkManager->disconnect();
			break;
		case NETWORK_EDITACCOUNTFAIL:
			...
			showOptionsOverlay(false);
			showBackdropOverlay(true,false);
			mAlertBox->showAlert(mLang->PassChangeFail(),0.5,0.5,3);
			mNetworkManager->disconnect();
			break;
		...
		case NETWORK_LOADCHARFAIL:
			showBackdropOverlay(true,false);
			mAlertBox->showAlert(mLang->CharLoadFail(),0.5,0.5,3);
			break;
		...
		case NETWORK_EDITCHARFAIL:
			showBackdropOverlay(false,false);
			showCharScreenOverlay(true);
			mAlertBox->showAlert(mLang->CharEditFail(),0.5,0.5,3);
			mCharScreenManager->refreshPage();
			break;
		case NETWORK_PARTYREQUEST:
			{
				...
				if(tUnit)
				{
					...
					String tCaption = tUnit->getUser()+mLang->Hass();
					tCaption += mUnitManager->hasParty()?mLang->Rquested():mLang->InvYou();
					tCaption += mLang->TJoinP();
	...
	void updateTargetPanel(const FrameEvent &evt)
	{
		...
		if(tTarget)
		{
			...
			if (tTarget->getType() == OBJECT_CRITTER)
{
OverlayManager::getSingleton().getOverlayElement("GUI/TargetHPText")->setCaption(StringConverter::toString(static_cast<MagixCritter*>(tTarget)->getHP()) + " HP");
}
else if (tTarget->getType() == OBJECT_UNIT)
{
OverlayManager::getSingleton().getOverlayElement("GUI/TargetHPText")->setCaption(StringConverter::toString(static_cast<MagixUnit*>(tTarget)->getHP()) + " HP");
}
	...
	void updateLogo(const FrameEvent &evt)
	{
		...
		if(mGameStateManager->getGameState()==GAMESTATE_STARTSCREEN && logoCount<=5)
		{
			...
			if(logoCount>=5)
			{
				...
				mCursor->show();
				mButtonText[BUTTON_NEWGAME]->setCaption(mLang->NewGame());
				mButton[BUTTON_NEWGAME]->show();
				mButtonText[BUTTON_MULTIPLAYER]->setCaption(mLang->Multiplayer());
				mButton[BUTTON_MULTIPLAYER]->show();
				mButtonText[BUTTON_ABOUT]->setCaption(mLang->About());
				mButton[BUTTON_ABOUT]->show();
				mButtonText[BUTTON_QUIT]->setCaption(mLang->Quit());
	...
	void updateTargetBioBox()
	{
		...
		const UTFString tBio = mNetworkManager->popTargetBioUpdated();
	...
	void updateEmoteBox()
	{
		...
		tList.push_back(mLang->Actions());
		if(mUnitManager->getPlayer()->isLaying()||mUnitManager->getPlayer()->isPlopped())tList.push_back(mLang->PlopDown());
		else if(mUnitManager->getPlayer()->isSitting())tList.push_back(mLang->Lay());
		else tList.push_back(mLang->Sit());
		if(mUnitManager->getPlayer()->isLeaning()||mUnitManager->getPlayer()->isRolledOver())tList.push_back(mLang->RollOver());
		else if(mUnitManager->getPlayer()->isSideLaying())tList.push_back(mLang->LayDown());
		else if(mUnitManager->getPlayer()->isSitting())tList.push_back(mLang->SideLay());
		else tList.push_back(mLang->Sit());
		tList.push_back(mUnitManager->getPlayer()->getIsCrouching()?mLang->StopCrouch():mLang->Crouch());
		tList.push_back(mLang->Point());
		tList.push_back(mLang->Stretch());
		tList.push_back(mLang->Headswing());
		tList.push_back(mLang->Headbang());
		tList.push_back(mLang->Buttswing());
		tList.push_back(mLang->Wingwave());
		tList.push_back(mLang->Moonwalk());
		tList.push_back(mLang->Thriller());
		tList.push_back(mLang->Rofl());
		tList.push_back(mLang->Roar());
		tList.push_back(mLang->Curl());
		tList.push_back(mLang->Faint());
		tList.push_back("");

		tList.push_back(mLang->SecondaryAct());
		tList.push_back(mLang->NodHead());
		tList.push_back(mLang->ShakeHead());
		tList.push_back(mLang->SlowNodHead());
		tList.push_back(mLang->ShakeSlowHead());
		tList.push_back(mLang->HeadTilt());
		tList.push_back(mUnitManager->getPlayer()->isLick()?mLang->StopLick():mLang->Lick());
		tList.push_back(mUnitManager->getPlayer()->isNuzzle()?mLang->StopNuzzle():mLang->Nuzzle());
		tList.push_back(mLang->Sniff());
		tList.push_back(mLang->TailFlick());
		tList.push_back(mLang->Laugh());
		tList.push_back(mLang->Chuckle());
		tList.push_back("");

		tList.push_back(mLang->Emotes());
	...
	void refreshFriendList()
	{
		...
		//Online Friends
		friendBoxList.push_back(mLang->OnlineFriends());
		...
		{
			friendBoxList.push_back(mLang->None());
			friendBoxListButton.push_back(LISTBUTTON_NONE);
		}
		...
		//Offline Friends
		friendBoxList.push_back(mLang->OfflineFriends());
		friendBoxListButton.push_back(LISTBUTTON_NONE);
		...
		//Players online
		friendBoxList.push_back(mLang->OnlinePlayers());
		friendBoxListButton.push_back(LISTBUTTON_NONE);
		...
		//Blocked list
		friendBoxList.push_back(mLang->BlockedList());
		friendBoxListButton.push_back(LISTBUTTON_NONE);
	...
	void refreshBio()
	{
		...
		UTFString tBio = mDef->loadBio(tName);
		if(tBio=="")tBio = mLang->None();
		...
		if(mHoverWindow)
		{
			...
			if(mHoverWindow==mBox[GUI_LOGONBOX])	//enter logon username/password
			{
				...
				if(isCursorOverButton(usernameText))
					toggleInputMode(false,usernameText,mLang->Username(),15,false,logonUsername,false);
				else if(isCursorOverButton(passwordText))
					toggleInputMode(false,passwordText,mLang->Password(),15,false,logonPassword,false,false,true);
				return;
			}
			if(mHoverWindow==mBox[GUI_CREATEACCOUNTBOX])	//enter new account details
			{
				const String tCaption[MAX_CREATEACCOUNTINFO] = {mLang->Username(),
																mLang->Password(),
																mLang->ConfirmPass(),
																mLang->Email(),
																mLang->Question(),
			...
			{
				const String tCaption[MAX_EDITACCOUNTINFO] = {mLang->Username(),
																mLang->OldPass(),
																mLang->NewPass(),
																mLang->ConfirmPass()};
				for(int i=0;i<MAX_EDITACCOUNTINFO;i++)
			...
			if(mHoverWindow==mBox[GUI_FRIENDBOX])	//friendbox options
			{
				...
				case LISTBUTTON_ONLINEFRIEND:
					mButtonText[BUTTON_LISTSELECT1]->setCaption(mLang->PM());
					mButtonText[BUTTON_LISTSELECT2]->setCaption(mLang->Where());
					mButtonText[BUTTON_LISTSELECT3]->setCaption(mLang->Remove());
					break;
				case LISTBUTTON_OFFLINEFRIEND:
				case LISTBUTTON_BLOCKED:
					mButtonText[BUTTON_LISTSELECT1]->setCaption(mLang->Remove());
					break;
				default:
					return;
				}
				...
				else
				{
					...
					if(tHotkey)
						if(tHotkey>=OIS::KeyCode::KC_F5 && tHotkey<=OIS::KeyCode::KC_F10)
						{
							...
							mChatManager->message(mLang->HotkeyF()+StringConverter::toString(tHotkey-OIS::KeyCode::KC_F5+5)+mLang->SetAs()+tEmote+"'");
						}
						else if(tHotkey>=OIS::KeyCode::KC_F11 && tHotkey<=OIS::KeyCode::KC_F12)
						{
							mDef->setHotkeyF(tHotkey-OIS::KeyCode::KC_F11+6,tEmote);
							mChatManager->message(mLang->HotkeyF()+StringConverter::toString(tHotkey-OIS::KeyCode::KC_F11+11)+mLang->SetAs()+tEmote+"'");
						}
					#pragma warning(pop)
				}
			...
			if(mHoverWindow==mBox[GUI_ITEMBOX])	//itembox options
			{
				...
				if(listButtonData!="")
				{
					mButtonText[BUTTON_LISTSELECT1]->setCaption(mLang->Stash());
					mButtonText[BUTTON_LISTSELECT2]->setCaption(mLang->Drop());
					mButton[BUTTON_LISTSELECT2]->show();
					if(mDef->isAdmin)
					{
						mButtonText[BUTTON_LISTSELECT3]->setCaption(mLang->Delete());
						mButton[BUTTON_LISTSELECT3]->show();
					}
			...
			if(mHoverWindow==mBox[GUI_STASHBOX])	//stashbox options
			{
				...
				mButtonText[BUTTON_LISTSELECT1]->setCaption(mLang->Equip());
	...
	void mouseLeftUp()
	{
		...
		if(isCursorOverButton(mHoverButton))
		{
			...
			if(mHoverButton==mButton[BUTTON_ABOUT])	//new game
			{
				showStartScreenOverlay(false);
				showCreditOverlay(true);
				return;
			}
			if(mHoverButton==mButton[BUTTON_CREDITBACK])	//new game
			{
				showCreditOverlay(false);
				showStartScreenOverlay(true);
				return;
			...
			if(mHoverButton==mButton[BUTTON_MULTIPLAYER])	//multiplayer game
			{
				...
				OverlayManager::getSingleton().getOverlayElement("GUI/LogonPasswordText")->setCaption(mLang->Password()+tPassword);

				if(logonUsername=="")
					toggleInputMode(false,OverlayManager::getSingleton().getOverlayElement("GUI/LogonUsernameText"),mLang->Username(),15,false,logonUsername,false);
				else
					toggleInputMode(false,OverlayManager::getSingleton().getOverlayElement("GUI/LogonPasswordText"),mLang->Password(),15,false,logonPassword,false,false,true);
				return;
			}
			...
			if(mHoverButton==mButton[BUTTON_CAMPAIGN1]||mHoverButton==mButton[BUTTON_CAMPAIGN2]||mHoverButton==mButton[BUTTON_CAMPAIGN3])	//Start Campaign
			{
				...
				showCampaignOverlay(false);
				showOptionsOverlay(false);
				showBackdropOverlay(true,true,mLang->Loading());
				showFaderOverlay(true);
				fadeOut(0);
				return;
			}
			...
			if(mHoverButton==mButton[BUTTON_CHARSCREENNEXT])	//Charscreen Next
			{
				...
				else if(tFlag==CHARSCREEN_CREATECHAR)
				{
					showCharScreenOverlay(false);
					mBackdrop->setMaterialName("GUIMat/Backdrop1");
					showBackdropOverlay(true,true,mLang->Creating());
				...
				else if(tFlag==CHARSCREEN_EDITCHAR)
				{
					showCharScreenOverlay(false);
					mBackdrop->setMaterialName("GUIMat/Backdrop1");
					showBackdropOverlay(true,true,mLang->Saving());
			...
			if(mHoverButton==mButton[BUTTON_TEXTOUTPUT])	//hide chatbox output
			{
				if(mBoxText[GUI_TEXTOUTPUT]->isVisible())
				{
					...
					mButtonText[BUTTON_TEXTOUTPUT]->setCaption(mLang->Show());
				}
				else
				{
					...
					mButtonText[BUTTON_TEXTOUTPUT]->setCaption(mLang->Hide());
				}
				return;
			}
			...
			if(mHoverButton==mButton[BUTTON_INTERFACE9])	//toggle use windows cursor
			{
				toggleLanguage();
				return;
			}
			...
			if(mHoverButton==mButton[BUTTON_LISTSELECT1]||mHoverButton==mButton[BUTTON_LISTSELECT2]||mHoverButton==mButton[BUTTON_LISTSELECT3]) //listselect buttons
			{
				...
				if(tFunction==mLang->PM())
				{
					if(mInputManager->getInputMode()==INPUT_CONTROL)toggleInputMode(false,mBoxText[GUI_TEXTINPUT],mLang->Say(),256,true,"/"+listButtonData+":");
					else mInputManager->setString("/"+listButtonData+":");
				}
				else if(tFunction==mLang->Where())
				{
					mChatManager->message(listButtonData+mLang->IsIn()+mNetworkManager->getPlayerMap(listButtonData)+".");
				...
				else if(tFunction==mLang->Remove())
				{
				...
				else if(tFunction==mLang->Stash())
				{
					...
					{
						mChatManager->message(mLang->FullStash());
					}
				}
				else if(tFunction==mLang->Drop())
				{
					mChatManager->message(mLang->Dropped()+listButtonData+".");
					unequipItem(listButtonLine);
				}
				else if(tFunction==mLang->Delete())
				{
					mChatManager->message(mLang->Deleted()+listButtonData+".");
					unequipItem(listButtonLine,false);
				}
				else if(tFunction==mLang->Equip())
				{
					if(!mGameStateManager->isCampaign())
					{
	...
	void toggleLanguage()
	{
		...
		std::string lng;
		lang = mLang->Lang();
		std::ofstream outFile("lang.cfg",std::ios::binary);
		if(lang=="en")
		{
			outFile.write("ru",2);
			lg = "Русский";
		...
		mAlertBox->showAlert(mLang->TakenCorrectEffects(),0.5,0.5,1.5);
		outFile.close();
		mLang->setLangues();
		OverlayManager::getSingleton().getOverlayElement("GUI/InterfaceButtonText9")->setCaption(lg);
	}
	void toggleInputMode(bool isEnter, OverlayElement *inputBox=0, String defaultCaption="Say: ", unsigned short charLimit=256, bool clearAtReturn=true, UTFString startText="", bool allowTempStorage=true, bool allowNewLine=false, bool hideText=false)
	{
		if(defaultCaption.c_str()==String("Say: "))defaultCaption=mLang->Say();
		...
		if(mInputManager->toggleInputMode())
		{
			if(mInputManager->getInputBox()==mBoxText[GUI_TEXTINPUT])
			{
				...
				if(tType == CHAT_COMMAND)
				{
					...
					{
						mDef->isModOn = true;
						mChatManager->message(mLang->ModModeOn());
					...
					{
						mDef->isModOn = false;
						mChatManager->message(mLang->ModModeOff());
					...
					else if(tParam==COMMAND_RELEASEPET)
					{
						...
						{
							mChatManager->message(mLang->YouReleased()+mUnitManager->getPlayer()->getPet()+".");
					...
					else if(tParam==COMMAND_PARTY)
					{
						...
						if(!unit)mChatManager->message(mLang->CannotFind()+tCaption+".",CHAT_PARTY);
						else party(unit);
					}
					...
					{
						if(tCaption=="")mChatManager->message(mLang->UsageSaveChat());
						else mChatManager->saveChatLog("./",tCaption+".txt");
					}
					else if(tParam==COMMAND_PVP)
					{
						MagixUnit* unit = mUnitManager->getByUser(tCaption);
						if(!unit)mChatManager->message(mLang->CannotFind()+tCaption+".");
						else
						{
							mChatManager->message(">>>Функция sendPvp() выполняется, параметры:");
							mChatManager->message(logonUsername);
							mChatManager->message(tCaption);
							mNetworkManager->sendPvp(logonUsername,tCaption);
						}
						mChatManager->message(">>>Выполнение команды завершено");
					}
					else if(tParam==COMMAND_COMMANDS)
					{
						mChatManager->message(mLang->HomeCmd());
						mChatManager->message("/sethome");
						mChatManager->message("/gohome");
						mChatManager->message("/resethome");
						mChatManager->message(mLang->FriendCmd());
						mChatManager->message("/friend [" + mLang->Nm() + "]");
						mChatManager->message("/unfriend [" + mLang->Nm() + "]");
						mChatManager->message("/block [" + mLang->Nm() + "]");
						mChatManager->message("/unblock [" + mLang->Nm() + "]");
						mChatManager->message(mLang->PetCmd());
						mChatManager->message("/releasepet");
						mChatManager->message("/petfollow");
						mChatManager->message(mLang->PartyCmd());
						mChatManager->message("/party [" + mLang->Nm() + "]");
						mChatManager->message(mLang->OtherCmd());
						mChatManager->message("/position");
						mChatManager->message("/roll");
						mChatManager->message("/clearall");
						mChatManager->message("/clear");
						mChatManager->message("/lipsync [" + mLang->Msg() + "]");
						mChatManager->message("/savechat [" + mLang->Filname() + "]");
						mChatManager->message("/pvp [" + mLang->Nm() + "]");
						if(mDef->isAdmin)
						{
							mChatManager->message("/createitem [" + mLang->Nm() + "]");
							mChatManager->message("/godspeak [" + mLang->Msg() + "]");
							mChatManager->message("/ban [" + mLang->Nm() + "];[" + mLang->NDays() + "] (" + mLang->LResort() + ")");
						}
						if(mDef->isMod)
						{
							mChatManager->message("/modon");
							mChatManager->message("/modoff");
							mChatManager->message("/ban [" + mLang->Nm() + "] (" + mLang->LResort() + ")");
						}
						if(mDef->isAdmin||mDef->isMod)
						{
							mChatManager->message("/kick [" + mLang->Nm() + "]");
							mChatManager->message("/goto [" + mLang->Map() + "]:[x] [y] [z]");
							mChatManager->message("/where [" + mLang->Nm() + "]");
							mChatManager->message("/whois [" + mLang->Playertoken() + "]");
							mChatManager->message("/massblock [" + mLang->Nm() + "]");
						}
					}
					else
					{
				...
				else
				{
					...
					if(tType==CHAT_PARTY||tType==CHAT_PARTYACTION||tType==CHAT_PARTYEVENT)
					{
						...
						else mChatManager->message(mLang->NoHearYou());
					}
					//normal send
		...
		if(mInputManager->getInputBox()==mBoxText[GUI_TEXTINPUT])
		{
			if(mInputManager->getInputMode()==INPUT_CONTROL)mButtonText[BUTTON_TEXTINPUT]->setCaption(mLang->Say2());
			else if(mInputManager->getInputMode()==INPUT_TEXT)mButtonText[BUTTON_TEXTINPUT]->setCaption(mLang->Send());
			return;
		}
		//Bio
		if(mInputManager->getInputBox()==mBoxText[GUI_BIOBOX] && mInputManager->getInputMode()==INPUT_CONTROL)
		{
			UTFString tBio = mInputManager->getInputText();
		...
		{
			mButtonText[BUTTON_HOMEBOX4]->setCaption(mLang->Change());
			...
			if(tDimension!=mGameStateManager->getDimension())
			{
				...
				{
					mAlertBox->showAlert(mLang->MDims(),0.5,0.5,2);
				}
				else
				{
		...
		if(object)
		{
			...
			if(flags==ITEM_MASK)
			{
				...
				if(isRightClick)mUnitManager->getPlayer()->setTarget(tItem->getPosition(),TARGET_RUNTOPICKUP);
				{
					...
					mButtonText[BUTTON_SELECTBOX1]->setCaption(mLang->Equip());
			...
			if(flags==CRITTER_MASK)
			{
				...
				if(!isRightClick)
				{
					...
					if(tCritter->getIsPet() && tCritter->imTheOwner())
					{
						...
						mButtonText[BUTTON_SELECTBOX1]->setCaption(mLang->Pet());
						mButtonText[BUTTON_SELECTBOX2]->setCaption(tFlags->stay?mLang->Follow():mLang->Stay());
						mButtonText[BUTTON_SELECTBOX3]->setCaption(tFlags->shrink?mLang->Grow():mLang->Shrink());
						if(tCritter->getCritterType()=="Manta")mButtonText[BUTTON_SELECTBOX4]->setCaption(tFlags->shrink?mLang->Devolve():mLang->Evolve());
						else mButtonText[BUTTON_SELECTBOX4]->setCaption("");
					}
					//admins & mods can shrink
					else if(tCritter->getIsPet() && (mDef->isAdmin || mDef->isMod))
					{
						const PetFlags *tFlags = mUnitManager->getPlayer()->getPetFlags();
						mButtonText[BUTTON_SELECTBOX1]->setCaption(mLang->Pet());
						mButtonText[BUTTON_SELECTBOX2]->setCaption("");
					...
					{
						if(tCritter->getIsDrawPoint())mButtonText[BUTTON_SELECTBOX1]->setCaption(!tCritter->getIsDead()?mLang->Draw():"");
						else if(!tCritter->matchAlliance(mUnitManager->getPlayer()->getAlliance()))mButtonText[BUTTON_SELECTBOX1]->setCaption(!tCritter->getIsDead()?mLang->Attack():"");
						else mButtonText[BUTTON_SELECTBOX1]->setCaption((tCritter->getAnim()!="Run"&&tCritter->getAnim()!="Praise"&&!tCritter->isAttacking())?(tCritter->getIsPet()?mLang->Pet():mLang->Praise()):"");
						mButtonText[BUTTON_SELECTBOX2]->setCaption("");
						mButtonText[BUTTON_SELECTBOX3]->setCaption("");
						mButtonText[BUTTON_SELECTBOX4]->setCaption("");
					}
			...
			if(object!=mUnitManager->getPlayer()->getObjectNode())
			{
				...
				if(!isRightClick)
				{
					...
					{
						mButtonText[BUTTON_SELECTBOX1]->setCaption( (static_cast<MagixIndexedUnit*>(tUnit)->isFriend?mLang->RemoveFr():mLang->AddFr()) );
						mButtonText[BUTTON_SELECTBOX2]->setCaption( (static_cast<MagixIndexedUnit*>(tUnit)->isBlocked?mLang->Unblock():mLang->Block()) );
						mButtonText[BUTTON_SELECTBOX3]->setCaption(mLang->ViewBio());
						if(mUnitManager->isPartyMember(tUnit))mButtonText[BUTTON_SELECTBOX4]->setCaption("");
						else mButtonText[BUTTON_SELECTBOX4]->setCaption( mUnitManager->hasParty()?mLang->InviteP():mLang->JoinP() );
					}
					else
					{
						mButtonText[BUTTON_SELECTBOX1]->setCaption(tIsAlly?"":mLang->Attack());
						mButtonText[BUTTON_SELECTBOX2]->setCaption("");
						mButtonText[BUTTON_SELECTBOX3]->setCaption("");
						mButtonText[BUTTON_SELECTBOX4]->setCaption("");
					}
	...
	void processSelectBoxClick()
	{
		...
		const String tFunction = tButtonText->getCaption();
			...
			else if(tFunction=="View Bio")
			{
				...
				if(!mGameStateManager->isCampaign())
				{
					refreshTargetBio(mLang->Loading(),tTarget->getName());
			...
			else if(tFunction==mLang->Attack())
			{
				if(mUnitManager->getPlayer()->getIsWounded())
				{
					mChatManager->message(mLang->CannotAttack());
					return;
				}
				MagixUnit *tUnit = mUnitManager->getByObjectNode(mCurrentObject);
				if(tUnit)
	...
	void doAttack(MagixLiving *target=0)
	{
		...
		if(mUnitManager->getPlayer()->isSkillMode())
		{
			...
			else
			{
				...
				{
					mChatManager->message(mLang->TargetNeed());
					return;
				}
	...
	void showChatBox(bool flag, bool showInput=true)
	{
		...
		else
		{
			...
			if(showInput)
			{
				...
				mButtonText[BUTTON_TEXTINPUT2]->setCaption(mLang->Hide());
			}
			else
			{
				mBox[GUI_TEXTINPUT]->hide();
	...
	{
		bool tTablet=false,tShadowsOn=false,tBloom=false,tGeneralCharname=false,tLocalUsername=false,tChannelBlink=true,tRunMode=true,tDoubleJumpOn=true,tAutoLipSync=false,Language=true;
		Real tMusicVol=1,tGuiVol=1,tSoundVol=1;
		mDef->loadSettings(tTablet,mouseSensitivity,tMusicVol,tGuiVol,tSoundVol,tShadowsOn,tBloom,logonUsername,tGeneralCharname,tLocalUsername,tChannelBlink,tRunMode,tDoubleJumpOn,tAutoLipSync,useWindowsCursor,Language);

		if(tTablet)toggleIsTablet();
		toggleShadowsOn();
		if(!tShadowsOn)toggleShadowsOn();
		if(tBloom)toggleIsBloom();
		mButtonText[BUTTON_SETTINGS3]->setCaption((mDef->pagedGeometryOn?mLang->On():mLang->Off()));
		...
		OverlayManager::getSingleton().getOverlayElement("GUI/LogonUsernameText")->setCaption(mLang->Username()+logonUsername);
	}
	void saveSettings()
	{
		mDef->saveSettings(isTabletFlag, mouseSensitivity,
						...
						isDoubleJumpOnFlag,
						isAutoLipSyncFlag,
						(mButtonText[BUTTON_INTERFACE8]->getCaption()==mLang->On()));
	}
	void toggleIsTablet(bool showAlert=false)
	{
		isTabletFlag = !isTabletFlag;
		mButtonText[BUTTON_INTERFACE1]->setCaption((isTabletFlag?mLang->On():mLang->Off()));
		if(showAlert)mAlertBox->showAlert( (isTabletFlag?mLang->TabletOn():mLang->TabletOff()) ,0.5,0.5);
	}
	bool isTablet()
	{
		return isTabletFlag;
	...
	void toggleShadowsOn()
	{
		...
		mButtonText[BUTTON_SETTINGS1]->setCaption((isShadowsOnFlag?mLang->On():mLang->Off()));
	...
	void toggleIsBloom()
	{
		...
		mButtonText[BUTTON_SETTINGS2]->setCaption((isBloomFlag?mLang->On():mLang->Off()));
	...
	void toggleDoChannelBlink()
	{
		...
		mButtonText[BUTTON_INTERFACE4]->setCaption((doChannelBlink?mLang->On():mLang->Off()));
	}
	void toggleDoGeneralCharname()
	{
		mChatManager->doGeneralCharname = !mChatManager->doGeneralCharname;
		mButtonText[BUTTON_INTERFACE2]->setCaption((mChatManager->doGeneralCharname?mLang->Character():mLang->Username2()));
	...
	void toggleDoLocalUsername()
	{
		...
		mButtonText[BUTTON_INTERFACE3]->setCaption((mChatManager->doLocalUsername?mLang->Username2():mLang->Character()));
	...
	void toggleRunMode()
	{
		...
		mButtonText[BUTTON_INTERFACE5]->setCaption((mUnitManager->getPlayer()->defaultControlModeIsAbsolute?mLang->Absolute():mLang->Relative()));
	}
	void toggleDoubleJumpOn()
	{
		isDoubleJumpOnFlag = !isDoubleJumpOnFlag;
		mButtonText[BUTTON_INTERFACE6]->setCaption((isDoubleJumpOnFlag?mLang->On():mLang->Off()));
	}
	void toggleAutoLipSync()
	{
		isAutoLipSyncFlag = !isAutoLipSyncFlag;
		mButtonText[BUTTON_INTERFACE7]->setCaption((isAutoLipSyncFlag?mLang->On():mLang->Off()));
	}
	void toggleUseWindowsCursor(bool dontShowAlert=false)
	{
		const bool tOn = (mButtonText[BUTTON_INTERFACE8]->getCaption()==mLang->On());
		mButtonText[BUTTON_INTERFACE8]->setCaption((!tOn?mLang->On():mLang->Off()));
		if(!dontShowAlert)mAlertBox->showAlert(mLang->TakenEffects(),0.5,0.5,1.5);
	}
	...
	void updateSkillText(const Skill *skill)
	{
		...
		else mSkillText->setCaption(mLang->Attack());
	}
	...
	void setChatChannel(const unsigned char &channel)
	{
		...
		{
			mButtonText[BUTTON_TEXTINPUT3]->setCaption(mLang->Local());
		...
		{
			mButtonText[BUTTON_TEXTINPUT3]->setCaption(mLang->General());
		...
		{
			mButtonText[BUTTON_TEXTINPUT3]->setCaption(mLang->Party());
	...
	void editFriendList(const String &name, bool add)
	{
		...
		mChatManager->message( (add?mLang->Added():mLang->Removed())+name+mLang->AsFriend());
	}
	void editBlockedList(const String &name, bool add)
	{
		...
		mChatManager->message( (add?mLang->Added():mLang->Removed()) +name+(add?mLang->To():mLang->From())+mLang->BlockList());
	}
	...
	void logOn()
	{
		if(logonUsername=="")
		{
			mAlertBox->showAlert(mLang->EnterUsername(),0.5,0.5,1.5);
			return;
		}
		if(logonPassword=="")
		{
			mAlertBox->showAlert(mLang->EnterPassword(),0.5,0.5,1.5);
			return;
		}
		isCreateAccount = false;
		isEditAccount = false;
		showLogonOverlay(false);
		showBackdropOverlay(true,true,mLang->Connecting());
	...
	void createAccount()
	{
		...
		{
			mAlertBox->showAlert(mLang->EnterPasswordConf(),0.5,0.5,1.5);
			return;
		}
		if(createAccountInfo[1]!=createAccountInfo[2])
		{
			mAlertBox->showAlert(mLang->ConfirmPasswordMiss(),0.5,0.5,1.5);
			return;
		}
		if(createAccountInfo[0][0]==' ')
		{
			mAlertBox->showAlert(mLang->NotWithSpace(),0.5,0.5,1.5);
			return;
		}
		for(int i=0;i<(int)createAccountInfo[0].length();i++)
		{
			...
			{
				mAlertBox->showAlert(mLang->NotContain(),0.5,0.5,1.5);
				return;
			}
		}
	...
	void confirmPasswordChange()
	{
		...
		{
			mAlertBox->showAlert(mLang->EnterOldPwd(),0.5,0.5,1.5);
			return;
		}
		if(editAccountInfo[2].length()==0)
		{
			mAlertBox->showAlert(mLang->EnterNewPwd(),0.5,0.5,1.5);
			return;
		}
		if(editAccountInfo[3].length()==0)
		{
			mAlertBox->showAlert(mLang->EnterNewPwdConf(),0.5,0.5,1.5);
			return;
		}
		if(editAccountInfo[2]!=editAccountInfo[3])
		{
			mAlertBox->showAlert(mLang->EnterConfPwdMiss(),0.5,0.5,1.5);
			return;
		}
		isEditAccount = true;
		isCreateAccount = false;
	...
	void loadChar()
	{
		...
		{
			showBackdropOverlay(true,false);
			mAlertBox->showAlert(mLang->ClickHere(),0.70,0.85,5);
		}
	}
	...
	void doRoll(const String &input)
	{
		...
		if(tInput.size()!=2)
		{
			mChatManager->message(mLang->UsageRoll());
			return;
		}
		...
		{
			mChatManager->message(mLang->MaxDice());
			return;
		}
		short tTotal = 0;
		for(short i=0; i<tDice; i++)tTotal += (short)Math::RangeRandom(1,tSides);

		const String tCaption = mLang->Rolled()+tInput[0]+mLang->Of()+tInput[1]+mLang->SideGot()+StringConverter::toString(tTotal);
	...
	bool checkItemEquippable(const String &meshName, bool isCreate=false,bool doEquip=false,bool ground=false)
	{
		...
		{
			mChatManager->message(mLang->CannotCreateItem());
			return false;
		}
		if(!mDef->itemMeshExists(meshName))
		{
			mChatManager->message(mLang->ItemNotExist());
			return false;
		}

		if(ground)
		{
			mChatManager->message(mLang->SpawnedItem()+mDef->getItemName(meshName)+".");
		...
		if(tSlot==-1)
		{
			mChatManager->message(mLang->CannotEquip());
			return false;
		}
		else if(doEquip)
		{
	...
	void equipItem(const String &meshName)
	{
		...
		if(tSlot!=-1)
		{
			...
			{
				mChatManager->message(mLang->Equipped()+mDef->getItemName(meshName)+".");
	...
	void loadCampaigns(const unsigned short &page)
	{
		...
		OverlayManager::getSingleton().getOverlayElement("GUI/CampaignText2")->setCaption(mLang->Page()+StringConverter::toString(campaignPage+1));
	}
	...
	void party(MagixUnit *unit)
	{
		...
		if(mUnitManager->hasParty())
		{
			...
			{
				mChatManager->message(mLang->PartyFull());
				return;
			}
			mNetworkManager->sendInfo(INFO_PARTYINVITE,static_cast<MagixIndexedUnit*>(unit)->getIndex());
			mChatManager->message(mLang->Inviting()+unit->getUser()+mLang->ToJoin(),CHAT_PARTY);
		}
		else
		{
			mNetworkManager->sendInfo(INFO_PARTYREQUEST,static_cast<MagixIndexedUnit*>(unit)->getIndex());
			mChatManager->message(mLang->IRequestingToJoin()+unit->getUser()+mLang->Sparty(),CHAT_PARTY);
		}
	}
};
