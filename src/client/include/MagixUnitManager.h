...
public:
	...
	void initialize(SceneManager *sceneMgr, MagixExternalDefinitions *def, MagixGameStateManager *gameStateMgr, MagixWorld *world, MagixEffectsManager *effectsMgr, MagixCollisionManager *collisionMgr, MagixSoundManager *soundMgr, MagixItemManager *itemMgr, MagixCritterManager *critterMgr, MagixCamera *camera)
	{
		...
		mNameTagAttr = new MovableTextOverlayAttributes("Attrs1",sceneMgr->getCamera("PlayerCam"),"orbitron-medium",16,ColourValue::White,"GUIMat/ButtonUp");
		mChatBubbleAttr = new MovableTextOverlayAttributes("Attrs2",sceneMgr->getCamera("PlayerCam"),"orbitron-medium",16,ColourValue(1,0.6,0),"GUIMat/StatsBlockCenter");
		mUserTagAttr = new MovableTextOverlayAttributes("Attrs3",sceneMgr->getCamera("PlayerCam"),"orbitron-medium",14,ColourValue(1,0.6,0),"GUIMat/ButtonUp");
	}
